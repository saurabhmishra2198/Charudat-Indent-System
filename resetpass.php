	...
	if(isset($_POST['submit']))
	{
	    ...
	    if(isset($_GET['pass']))
	    {
	    	...
	    	if($pass1 == $cpass)
	    	{
	    		...
	    		$query = "UPDATE `user2020` SET `emp_password`='$hash' WHERE emp_password = '".$_GET['pass']."' ";
	    		$result = mysqli_query($con,$query);
	    		if($result)
	    		{
	    			$_SESSION['msg'] = "Password created Successfully! Try to login again!";
	   	...
	   	{
	    	echo "<script> alert('Pass not get');</script>";
	    }
	}
?>
<!doctype html>
...
<form class="form-signin" action="#" method="post">
  ...
  <input type="text" id="pass1" name="pass1" class="form-control" placeholder="Enter Password" required autofocus>
